...
You can download the desktop app from https://app.tangoapp.dev/desktop. Because the Web app is cached in your browser, you might need to wait a few minutes for the new version to be updated.
